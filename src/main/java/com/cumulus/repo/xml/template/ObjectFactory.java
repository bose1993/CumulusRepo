 ...
 * element interface generated in the org.cumulus.certificate.model.test
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _TestBasedCertifcationModel_QNAME = new QName(
			"http://www.cumulus.org/certificate/model/test",
			"testBasedCertifcationModel");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.cumulus.certificate.model.test
	 * 
	 */
	 ...
	 * {@link TestCertificationModel }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.cumulus.org/certificate/model/test", name = "testBasedCertifcationModel")
	public JAXBElement<TestCertificationModel> createTestBasedCertifcationModel(
			TestCertificationModel value) {
		return new JAXBElement<TestCertificationModel>(
				_TestBasedCertifcationModel_QNAME,
				TestCertificationModel.class, null, value);
	}
