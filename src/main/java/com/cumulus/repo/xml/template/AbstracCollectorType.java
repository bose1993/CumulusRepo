...
/**
 * <p>
 * Classe Java per AbstracCollectorType complex type.
 * 
 * <p>
 ...
 *         &lt;element name="Capability" type="{http://www.cumulus.org/certificate/model/test}CapabilityType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AbstracCollectorType", propOrder = { "testCategory",
		"actionability", "capability", "testType", "testDescription",
		"testGenerationModelLink", "testAttributes", "testCases" })
public class AbstracCollectorType {
	 ...
	 * 
	 * @return possible object is {@link ActionabilityType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ActionabilityType }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link AbstracCollectorType.TestAttributes }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link AbstracCollectorType.TestAttributes }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link AbstracCollectorType.TestCases }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link AbstracCollectorType.TestCases }
	 * 
	 */
	...
	public static class TestAttributes {
		 ...
		 * <CODE>set</CODE> method for the testAttribute property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
