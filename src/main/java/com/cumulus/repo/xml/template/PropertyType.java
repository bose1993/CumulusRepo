...
/**
 * <p>
 * Classe Java per propertyType complex type.
 * 
 * <p>
...
@XmlType(name = "propertyType", propOrder = { "propertyPerformance",
...
public class PropertyType {
	 ...
	 * 
	 * @return possible object is {@link PropertyType.PropertyPerformance }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PropertyType.PropertyPerformance }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link PropertyType.PropertyParameterList }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PropertyType.PropertyParameterList }
	 * 
	 */
	public void setPropertyParameterList(
			PropertyType.PropertyParameterList value) {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "propertyParameter" })
	public static class PropertyParameterList {
		 ...
		 * <CODE>set</CODE> method for the propertyParameter property.
		 * 
		 * <p>
		 ...
		 * 
		 * <p>
		 * Il seguente frammento di schema specifica il contenuto previsto
		 * contenuto in questa classe.
		 * 
		 * <pre>
		 * &lt;complexType>
		 *   &lt;simpleContent>
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "propertyPerformanceRow" })
	public static class PropertyPerformance {
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the propertyPerformanceRow property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "propertyPerformanceCell" })
		public static class PropertyPerformanceRow {
			 ...
			 * not a <CODE>set</CODE> method for the propertyPerformanceCell
			 * property.
			 * 
			 * <p>
			 * For example, to add a new item, do as follows:
